...
public class MainPage extends BasePage {
    ...
    private final By hardFormsButton = By.xpath("//span[@class='round-tabs four']");
    ...
    private final By dragAndDrop = By.xpath("//div[@id = 'advanced']/*[3]/*[8]");
    ...
    public void clickHardButton() {
        webDriver.findElement(hardFormsButton).click();
    }
    ...
    public SlidersPage clickDragAndDropSliders() {
        webDriver.findElement(dragAndDrop).click();
        return new SlidersPage(webDriver);
    }
}
